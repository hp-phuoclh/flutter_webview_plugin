function showPopup(data) {
      ...
      for(var i =0; i< data["dialogs"]["LinkGroups"].length; i++) {
		...
		// Don't show external link'icon for internal app link
		if (tdData["StartupType"] == 1) {
      ...
      document.getElementById('flutter_modal_header').innerText = data["dialogs"]["StationName"] + '駅の情報';
